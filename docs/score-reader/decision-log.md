...
| Dependency licenses and notices     | User/project owner | pending | Approve exact versions/licenses for OSMD, ZIP/XML parser, OpenCV.js, Tesseract.js, ONNX Runtime Web, and model artifacts.                                                    |
