...
| M5A | complete | pending | fmt/lint/test/build green (315 passing) | N/A                                   | Dedicated OpenCV worker and deterministic preprocessing pipeline implemented: lazy-loaded @techstark/opencv-js, adaptive thresholding, horizontal projection deskew, 5-line staff grouping, barline slicing, memory leak tracking, cancellation via AbortSignal, and typed preparation entry point. |
